    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10 h-20 flex items-center justify-between">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="hidden md:inline-flex items-center gap-2 bg-caramel text-white px-5 py-2.5 rounded-full text-sm hover:bg-[color:var(--brown)] transition-colors"
        >
          Agendar conversa
        </a>
        ...
        <div className="lg:hidden bg-cream border-t border-border">
          <div className="px-6 py-6 flex flex-col gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center bg-caramel text-white px-5 py-3 rounded-full text-sm mt-2"
            >
              Agendar conversa
            </a>
          </div>
